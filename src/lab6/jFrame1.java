...
public class jFrame1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Какое время года было любимое в вашем детстве?");
        ...
        jRadioButton1.setBounds(14, 74, 120, 15);

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("Куклы");
        ...
        jRadioButton3.setText("Мягкие игрушки");
        ...
        jRadioButton4.setText("Другой вариант");
        ...
        jLabel2.setText("Какими игрушками нравилось играться в детстве?");
        jFrame3.getContentPane().add(jLabel2);
        jLabel2.setBounds(0, 20, 390, 17);
        ...
        jLabel6.setText("Выбрано: Машинки");
        ...
        jLabel3.setText("Какие песни вам нравились, когда вы были подростками? ");
        jFrame4.getContentPane().add(jLabel3);
        jLabel3.setBounds(10, 20, 450, 17);
    ...
    private void jFrame5WindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_jFrame5WindowActivated
        jTable2.setValueAt("Какими игрушками нравилось играться в детстве?", 0, 0);
        switch (buttonGroup1.getSelection().getActionCommand()) {
            case "0":
                jTable2.setValueAt("Машинки", 0, 1);
                break;
            case "1":
                jTable2.setValueAt("Куклы", 0, 1);
                break;
            case "2":
                jTable2.setValueAt("Мягкие игрушки", 0, 1);
                break;
            case "3":
                jTable2.setValueAt("Другой вариант", 0, 1);
                break;
        }

        jTable2.setValueAt("Какие песни вам нравились, когда вы были подростками?", 1, 0);
        switch (buttonGroup2.getSelection().getActionCommand()) {
            case "4":
                jTable2.setValueAt("Реп", 1, 1);
                break;
            case "5":
                jTable2.setValueAt("Рок", 1, 1);
                break;
            case "6":
                jTable2.setValueAt("Джаз", 1, 1);
                break;
            case "7":
                jTable2.setValueAt("Поп-музыка", 1, 1);
                break;
        }

        jTable2.setValueAt("Какое время года было любимое в вашем детстве?", 2, 0);
        switch (jTable1.getSelectedRow()) {
            case 0:
                jTable2.setValueAt("Зима", 2, 1);
                break;
            case 1:
                jTable2.setValueAt("Весна", 2, 1);
                break;
            case 2:
                jTable2.setValueAt("Лето", 2, 1);
                break;
            case 3:
                jTable2.setValueAt("Осень", 2, 1);
                break;
            default:
                jTable2.setValueAt("Не могу выбрать", 2, 1);
        }
